...
<?php } else { ?>
	...
	<?php 
		...
		$destino = get_the_ID();
	?>
		<a href="https://ademperu.com/cursos/compra.php?destino=<?= $destino; ?>&cliente=<?= wp_get_current_user()->ID; ?>">
		<div class="course-wishlist-box" style="background: black; padding: 5px 15px;">
		<span><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>ADQUIRIR CURSO</span> </span>
		</div>
		</a>
<?php } ?>
